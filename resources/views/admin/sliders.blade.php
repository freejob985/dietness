...
<div class="card card-custom">
							<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">{{__('admin.sliders.sliders')}}</h3>
										</div>
										<div class="card-toolbar">
											<!--begin::Button-->
											<a href="{{route($prefix.'_add_post_slider')}}" class="btn btn-primary font-weight-bolder">
...
</svg><!--end::Svg Icon--></span>{{__('admin.sliders.add_slider')}}</a>
											<!--end::Button-->
										</div>
									</div>		
									<div class="card-body">
										...
										<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
											<thead>
												<tr>
													<th title="Field #1">#</th>
													<th title="Field #2">{{__('admin.sliders.image')}}</th>
													<th title="Field #4">{{__('admin.sliders.created_at')}}</th>
													<th title="Field #5">{{__('admin.sliders.options')}}</th>
											...
											<tbody>
												...
												<tr>
													...
													<td><img style="width:90px;" src="{{asset('/uploads/sliders/'.$slider->image)}}"></td>
													<td>{{Carbon::parse($slider->created_at)->format('Y-m-d')}}</td>
													<td>
                                                        <a title="{{__('admin.main_categories.edit_main_categories')}}" href="{{route($prefix.'_editSlider',['id' => $slider->id])}}"><i class="icon-xl la la-edit"></i></a>
                                                        <a title="{{__('admin.main_categories.remove_main_categories')}}" href="#" class="remove_btn" data="{{route($prefix.'_slider_remove',['id' => $slider->id])}}"><i class="icon-xl la la-trash"></i></a>
                                                    </td>
