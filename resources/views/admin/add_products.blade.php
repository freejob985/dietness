...
<!--begin::Card-->
										<div class="card card-custom gutter-b example example-compact">
											<div class="card-header">
												<h3 class="card-title">{{__('admin.products.add_product')}}</h3>
												
											</div>
											<!--begin::Form-->
											<form action="{{route($prefix.'_add_post_products')}}" method="post" enctype="multipart/form-data">
                                                                                   {{csrf_field()}}
												<div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @endphp
                                                            ...
                                                            <select class="form-control m-select2" id="day" name="day[]" multiple>
                                                                @foreach($days as $day)
                                                                    <option value="{{$day}}" @if(old('day') && in_array($day,old('day'))) selected @endif>{{__('admin.products.days.'.$day)}}</option>
                                                                @endforeach
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="form-group">
                                                       ...
                                                       <div class="form-group">
                                                           ...
                                                           <textarea type="text" class="form-control" name="description_en" rows="4">{{old('description_en')}}</textarea>
                                                        </div>
                                                       <div class="form-group">
                                                            <label>{{__('admin.products.description_ar')}}</label>
                                                           <textarea type="text" class="form-control" name="description_ar" rows="4">{{old('description_ar')}}</textarea>
                                                        </div>
                                                    </div>
