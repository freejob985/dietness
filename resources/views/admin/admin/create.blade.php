        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">{{__('admin.admins.add_admins')}}</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control m-select2" id="permissions" name="permissions[]" multiple="multiple"
                                ...
                                <option value="{{$permission->id}}" @if(old('permission') && in_array($permission->id, old('permission'))) selected
                                    @endif >
