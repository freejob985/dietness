...
<!--begin::Card-->
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form action="{{route($prefix.'_edit_post_slider',['id'=>$slider->id])}}" method="post" enctype="multipart/form-data">
                                                                                   {{csrf_field()}}
												<div class="card-body">
											...
											<div class="dropzone_gallery" style="background-image:url({{asset('/uploads/sliders/'.$slider->image)}})">
...
<div class="col-lg-11">
  ...
  <div class="tab-pane fade show active" id="arabic" role="tabpanel" aria-labelledby="v-pills-home-tab">
                <div class="">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="first_word_ar" value="{{$slider->first_word_ar}}">
                            </div>
                        <div class="form-group">
                            <label>{{__('admin.sliders.second_word')}}</label>
                            <input type="text" class="form-control" name="second_word_ar" value="{{$slider->second_word_ar}}">
                            </div>
                          <div class="form-group">
                            <label>{{__('admin.sliders.description')}}</label>
                              <textarea type="text" class="form-control" name="description_ar">{{$slider->description_ar}}</textarea>
                            </div>
                        <div class="row">
                                    <div class="col-lg-6">
                            <div class="form-group">
                            <label>{{__('admin.sliders.first_btn')}}</label>
                            <input type="text" class="form-control" name="first_btn_ar" value="{{$slider->first_btn_ar}}">
                            </div>
                            </div>
                                    <div class="col-lg-6">
                            <div class="form-group">
                            <label>{{__('admin.sliders.second_btn')}}</label>
                            <input type="text" class="form-control" name="second_btn_ar" value="{{$slider->second_btn_ar}}">
                            </div>
                            </div>
                                                            </div>
      </div>
  ...
  <div class="tab-pane fade" id="english" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        ...
                        <div class="form-group">
                            <label>{{__('admin.sliders.first_word')}}</label>
                            <input type="text" class="form-control" name="first_word_en" value="{{$slider->first_word_en}}">
                            </div>
                        <div class="form-group">
                            <label>{{__('admin.sliders.second_word')}}</label>
                            <input type="text" class="form-control" name="second_word_en" value="{{$slider->second_word_en}}">
                            </div>
                          <div class="form-group">
                            <label>{{__('admin.sliders.description')}}</label>
                              <textarea type="text" class="form-control" name="description_en">{{$slider->description_en}}</textarea>
                            </div>
                        <div class="row">
                                    <div class="col-lg-6">
                            <div class="form-group">
                            <label>{{__('admin.sliders.first_btn')}}</label>
                            <input type="text" class="form-control" name="first_btn_en" value="{{$slider->first_btn_en}}">
                            </div>
                            </div>
                                    <div class="col-lg-6">
                            <div class="form-group">
                            <label>{{__('admin.sliders.second_btn')}}</label>
                            <input type="text" class="form-control" name="second_btn_en" value="{{$slider->second_btn_en}}">
                            </div>
                            </div>
                                                            </div>
      </div>
